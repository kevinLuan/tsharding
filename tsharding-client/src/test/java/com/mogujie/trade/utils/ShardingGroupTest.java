...
public class ShardingGroupTest {
	@Test
	public void test() throws IllegalAccessException, IllegalArgumentException, NoSuchMethodException, SecurityException {
		init();
		process();
		System.out.println("-------------");
		processCRC32Rule();
	...
	private static void processCRC32Rule()
			throws IllegalAccessException, IllegalArgumentException, NoSuchMethodException, SecurityException {
		Method method = null;
	...
	public static ShardingHanderEntry create() throws NoSuchMethodException, SecurityException, IllegalAccessException {
	...
	public static ShardingHanderEntry create1() throws NoSuchMethodException, SecurityException, IllegalAccessException {
		Method method = ShopOrderMapper.class.getMethod("batchUpdateShopOrderByShopOrderIds", List.class, ShopOrder.class);
		ShardingHanderEntry shardingHanderEntry = new ShardingHanderEntry(ShopOrderMapper.class, method);
		return shardingHanderEntry;
	}
}
